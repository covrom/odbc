...
var (
	...
	procSQLAllocHandle     = mododbc32.NewProc("SQLAllocHandleW")
	procSQLBindCol         = mododbc32.NewProc("SQLBindColW")
	procSQLBindParameter   = mododbc32.NewProc("SQLBindParameterW")
	procSQLCloseCursor     = mododbc32.NewProc("SQLCloseCursorW")
	procSQLDescribeColW    = mododbc32.NewProc("SQLDescribeColW")
	procSQLDescribeParam   = mododbc32.NewProc("SQLDescribeParamW")
	procSQLDisconnect      = mododbc32.NewProc("SQLDisconnectW")
	procSQLDriverConnectW  = mododbc32.NewProc("SQLDriverConnectW")
	procSQLEndTran         = mododbc32.NewProc("SQLEndTranW")
	procSQLExecute         = mododbc32.NewProc("SQLExecuteW")
	procSQLFetch           = mododbc32.NewProc("SQLFetchW")
	procSQLFreeHandle      = mododbc32.NewProc("SQLFreeHandleW")
	procSQLGetData         = mododbc32.NewProc("SQLGetDataW")
	procSQLGetDiagRecW     = mododbc32.NewProc("SQLGetDiagRecW")
	procSQLNumParams       = mododbc32.NewProc("SQLNumParamsW")
	procSQLNumResultCols   = mododbc32.NewProc("SQLNumResultColsW")
	procSQLPrepareW        = mododbc32.NewProc("SQLPrepareW")
	procSQLRowCount        = mododbc32.NewProc("SQLRowCountW")
	procSQLSetEnvAttr      = mododbc32.NewProc("SQLSetEnvAttrW")
